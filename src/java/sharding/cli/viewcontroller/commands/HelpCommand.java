...
public class HelpCommand extends ACLIClientCommand {
  ...
  public static final String helpMenu = "+++++++++++++++++++++++++++++++++\n"
      ...
      + "(6) encrypt.....enter a message to be encrypted using the generated RSA key\n"
      + "(7) assemble-key.....assemble the private RSA key from a valid number of shamir shards\n"
      + "(8) decrypt.....enter a ciphertext to be decrypted using the private RSA key reassembled from Shamir shards\n"
      + "(9) help/h.....displays this help menu\n"
      + "(10) quit/q.....quits the Sharding CLI\n";
